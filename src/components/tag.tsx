export default function Tag({ id, label, remove }: {
    id: number,
    label: string,
  ...
  return (
    <div className={'bg-white/[7.5%] rounded-md text-nowrap flex items-center justify-center space-x-1 pl-2.5 pr-2'}>
      <p className={'text-[12px] font-medium text-neutral-300'}>{label}</p>
      <button className={'size-3.5 mr-2'} onClick={() => remove(id)}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={'text-blue-200'}>
