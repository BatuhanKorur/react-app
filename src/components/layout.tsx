...
export default function Layout({ children }: React.PropsWithChildren){
  return (
    <div className="w-full h-svh max-w-screen-md mx-auto">
      ...
      <div className={'my-6 flex items-center justify-between w-full border border-white/15 px-10 py-5 rounded-lg'}>
        <Link to={'/'}
              className={'text-[15px] font-medium opacity-50 transition duration-300 ease-in-out hover:opacity-100'}>
          <p>Home</p>
        </Link>
        <Link target={'_blank'}
              to="https://github.com/BatuhanKorur/react-app"
              className={'size-7'}>
